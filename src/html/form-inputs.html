                                ...
                                <form class="mt-3">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="nametext2" aria-describedby="name"
                                            placeholder="Name">
                                        <small id="name1"
                                            class="badge badge-default text-bg-info">Helper
                                            Text</small>
                                    </div>
                                </form>
                            </div>
                                ...
                                <form class="mt-3">
                                    <div class="form-group mb-0">
                                        ...
                                        <p class="text-center mb-0">
                                            <small id="name45"
                                                class="badge badge-default text-bg-warning text-white">Helper
                                                Text</small>
                                        </p>
                                    </div>
                                </form>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">To use add <code>float-end</code> class to the text</h6>
                                <form class="mt-3">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="nametext12" aria-describedby="name"
                                            placeholder="Name">
                                        <small id="name13"
                                            class="badge badge-default text-bg-danger form-text float-end">Helper
                                            Text</small>
                                    </div>
                                </form>
                            </div>
                                ...
                                <form class="mt-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 block-tag">
                                            <small class="badge badge-default text-bg-success">Helper
                                                Text</small>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="mt-3">
                                    <input type="text" data-bs-toggle="tooltip" data-placement="bottom"
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="mt-3">
                                    <input type="text" data-bs-toggle="tooltip" data-placement="right"
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="mt-3">
                                    <input type="text" data-bs-toggle="tooltip" data-placement="top" title="Tooltip on top"
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="mt-3">
                                    <input type="text" data-bs-toggle="tooltip" data-placement="left"
